    ...
    <main>
      <section className="hero">
        ...
        <p className="hero-description">
          One place to learn, search, practice and understand knowledge that
          matters.
        </p>
        ...
        <div className="hero-actions">
          ...
          <a href="/ask" className="secondary-button">
            🤖 Ask AGS
          </a>
        </div>
      </section>
      ...
      <section className="explore-section">
        ...
        <div className="explore-grid">
          <a href="/education" className="explore-card">
            <div className="explore-icon">📚</div>
            <h3>Education</h3>
            <p>Explore education knowledge.</p>
          </a>

          <a href="/exams" className="explore-card">
            <div className="explore-icon">🎓</div>
            <h3>Government Exams</h3>
            <p>Prepare with structured exam knowledge.</p>
          </a>

          <a href="/tests" className="explore-card">
            <div className="explore-icon">📝</div>
            <h3>Tests</h3>
            <p>Practice and test your understanding.</p>
          </a>

          <a href="/search" className="explore-card">
            <div className="explore-icon">🔎</div>
            <h3>Search</h3>
            <p>Find knowledge quickly.</p>
          </a>
        </div>
      </section>
    </main>
  ...
  useEffect(() => {
    async function loadTopic() {
      try {
        ...
        const backendContent = found.content || {};
        ...
        setContent({
          ...
          overview:
            ...
            backendContent.overview ||
            `Learn about ${found.title}.`,
          learningGoals: backendContent.learningGoals || [],
          prerequisites: backendContent.prerequisites || [],
          topics: backendContent.topics || [],
          revision: backendContent.revision || [],
          examTips: backendContent.examTips || [],
          commonMistakes: backendContent.commonMistakes || [],
          test: backendContent.test || [],
          sources: backendContent.sources || [],
        });
      } catch (err) {
        console.error(err);
    ...
    return (
      <main className="page">
        <section className="page-hero">
          ...
          <p>Please wait while we load this topic.</p>
        </section>
      </main>
    );
  }
...
function NotFound() {
  return (
    <main className="not-found">
      <p className="eyebrow">AGS KNOWLEDGE HUB</p>
